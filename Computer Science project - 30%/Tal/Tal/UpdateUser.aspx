<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="Tal.UpdateUser" %>
        ...
        <table border-collapse: collapse; border: 1px solid black; style="margin:auto;"; 
            ...
            <thead>
                <tr style="text-align: center">
                    <th class="note" colspan="3" style="font-size: 25px;">טופס עדכון נתונים</th>
                </tr>
            </thead>
            ...
            <tr>
                <td>שם משתמש</td>
                <td>
                    <input type="text" id="username" name="username" value="<%Response.Write(username); %>" size="15" disabled/></td>
                <td>
                    <input type="text" id="mUsername" name="musername" size="15"
                        style="display: none; background-color: mediumspringgreen; font-weight: bold;" /></td>
            </tr>
            <tr>
                <td>סיסמא</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="birthDateYear" name="birthDateYear" value="<% Response.Write(BirthYear); %>"
                        size="10" />
                </td>
                <td>
